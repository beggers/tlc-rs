...
fn division_infix_op_terminated_conjlist() {
  read_and_parse::test("testdata/conjlist.tla", "Division Infix Op Terminated Conjlist");
}
...
fn conjlist_terminated_by_parentheses() {
  read_and_parse::test("testdata/conjlist.tla", "Conjlist Terminated by Parentheses");
}


#[test]
fn nested_conjlist_terminated_by_parentheses() {
  read_and_parse::test("testdata/conjlist.tla", "Nested Conjlist Terminated by Parentheses");
}
